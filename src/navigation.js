...
import TaskManager from './screen/Task Manager/taskmanager';
import AddTaskm from './screen/Task Manager/addtask';
...
const Navigation = () => (
  <NavigationContainer>
    <RootStack.Navigator
      ...
      <RootStack.Screen name="TaskManager" component={TaskManager} />
      <RootStack.Screen name="AddTaskm" component={AddTaskm} />
      <RootStack.Screen
